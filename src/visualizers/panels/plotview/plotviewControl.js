...
define([
  ...
  PlotViewControl.prototype._getObjectDescriptor = function (nodeId) {
    ...
    var isConn = GMEConcepts.isConnection(nodeId);
    if (isConn) {
      ...
      for (var i = 0; i < pointerNames.length; i++) {
        pname = pointerNames[i];
        pointerId.push(node.getPointerId(pname));
      }
      ...
      if (node) {
        objDescriptor = {
          ...
          metaName: metaNode.getAttribute(nodePropertyNames.Attributes.name),
          childrenIds: node.getChildrenIds(),
          attributeValue: aName,
          parentId: node.getParentId(),
          isConnection: GMEConcepts.isConnection(nodeId),
          pointerSrc: pointerId[0],
          pointerDst: pointerId[1],
        };
      }
