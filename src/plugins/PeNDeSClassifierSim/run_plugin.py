"""
This script is called by the plugin-wrapper, PeNDeSClassifierSim.js, which passes down the
...
from PeNDeSClassifierSim import PeNDeSClassifierSim
...
plugin = PeNDeSClassifierSim(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
